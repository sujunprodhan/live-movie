...
const Footer = () => {
  return (
    <footer className="bg-slate-900 border-t border-slate-800 text-gray-300 py-10 mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex flex-col items-center md:items-start">
            ...
            <p className="mt-2 text-sm text-gray-400 text-center md:text-left">
              Your ultimate guide to exploring the cinematic world.
            </p>
          </div>
        ...
        <div className="mt-8 border-t border-slate-800 pt-8 flex justify-center">
          <p className="text-sm text-gray-500">
            &copy; {new Date().getFullYear()} LiveMovie. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
